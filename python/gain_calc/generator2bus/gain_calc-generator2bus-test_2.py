...
#
#   *reactive power is increased by 0.2 the nominal Active Power,
#
M_Ubus_after = []
M_Gain=[]
for pv_generator in pv_generators:
...
root = tk.Tk()
root.withdraw()
file_name_ = filedialog.asksaveasfilename(initialfile='gain_generator2bus-test_2',title='Select a location to save the CSV file',filetypes=[('Semicolon Separated Value file', '*.csv')],defaultextension=".csv")
if not file_name_:
